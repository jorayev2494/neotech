<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <header class="widget-header">
            {{ $title or "aliasess!" }}
            <a href="{{ route('admin.groups.create') }}" class="btn btn-success" style="float: right;">Создать</a>
        </header>    
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <button class="btn btn-transparent btn-transparent-soueccess btn-xs">
                                            ...
                                            <a href="{{ route('admin.groups.edit', $group->id) }}" style="color: #08ed72 !important;">Edit</a>
                                            </span>
                                        </button>
                                        
                                        <div class="btn btn-transparent btn-transparent-danger btn-xs">
                                            {!! Form::open(["url" => route("admin.groups.destroy", $group->id), "method" => "POST"]) !!}
